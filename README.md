...
Alter numeric values in text fields of any application using autohotkey clipboard manipulation. Preserves clipboard contents using aggressive async state management. Written in AutoHotkey_L (1.1.32.00) for Microsoft Windows. https://www.autohotkey.com
